...
export default function ProgramsReveal({
  ...
  return (
    <div className="onam-stage scene-enter flex flex-col items-center justify-center">
      ...
      {showingReelBeat && (
        <div className="pointer-events-none absolute inset-y-0 left-1/2 z-[5] w-full max-w-6xl -translate-x-1/2 overflow-hidden border-x border-onam-gold/20 bg-black/20 backdrop-blur-xl">
